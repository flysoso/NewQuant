#ifndef WEAK_ORDER2_0TAYLOR_METHOD_H
#define WEAK_ORDER2_0TAYLOR_METHOD_H
...
namespace NewQuant
{
    ...
    class WeakOrder2_0TaylorMethod1D
    {
    public :

        // Constructer
        WeakOrder2_0TaylorMethod1D(){}
        ~WeakOrder2_0TaylorMethod1D(){}
    ...
    private :
        WeakOrder2_0TaylorMethod1D(const WeakOrder2_0TaylorMethod1D &em);
        WeakOrder2_0TaylorMethod1D & operator = (const WeakOrder2_0TaylorMethod1D &em);
    ...
    template <typename TYPE>
    template <typename SDE>
    void WeakOrder2_0TaylorMethod1D<TYPE> ::ChackInitialization(const SDE &sde) const
    {
    ...
    template <typename TYPE>
    template <typename SDECLASS, typename RAND, typename CONTAINER>
    void WeakOrder2_0TaylorMethod1D<TYPE> ::Simulate(const ItoDiffusion1D<TYPE, SDECLASS> &sde, RAND &norm, CONTAINER &contain) const
    {
    ...
    template <typename TYPE>
    template <typename SDECLASS, typename RAND, typename CONTAINER>
    void WeakOrder2_0TaylorMethod1D<TYPE> ::Simulate(const ItoDiffusion1D<TYPE, SDECLASS> &sde, RAND &norm1, RAND &norm2, CONTAINER &contain) const
    {
        ChackInitialization(sde);
    ...
    template <typename TYPE>
    template <typename SDECLASS>
    TYPE WeakOrder2_0TaylorMethod1D<TYPE> ::Postfix(const ItoDiffusion1D<TYPE, SDECLASS> &sde, const TYPE &x, const TYPE &norm1, const TYPE &norm2, const TYPE &dt, const TYPE &sqrt_dt) const
    {
...
#endif //WEAK_ORDER2_0TAYLOR_METHOD_H
